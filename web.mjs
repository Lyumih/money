...
(function ($) {
    class $money_app extends $mol_view {
        ...
        Skill_description() {
            const obj = new this.$.$mol_text();
            obj.text = () => "# *Зарегистрировать карту*";
            return obj;
        }
        Skill_save() {
            const obj = new this.$.$mol_button_major();
    ...
    __decorate([
        $mol_mem
    ], $money_app.prototype, "Email", null);
    __decorate([
        $mol_mem
    ], $money_app.prototype, "Password", null);
    __decorate([
        $mol_mem
    ], $money_app.prototype, "Login", null);
    __decorate([
        $mol_mem
    ], $money_app.prototype, "Auth_form", null);
    __decorate([
        $mol_mem
    ], $money_app.prototype, "Auth_page", null);
    __decorate([
        $mol_mem
    ], $money_app.prototype, "Skill_description", null);
    __decorate([
        $mol_mem
