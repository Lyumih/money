...
;
	($.$money_app_skills) = class $money_app_skills extends ($.$mol_page) {
		Skills_level_0(){
			const obj = new this.$.$mol_text();
	...
	($mol_mem(($.$money_app_skills.prototype), "Skills_level_0"));
	($mol_mem(($.$money_app_skills.prototype), "Skill_link"));
	($mol_mem(($.$money_app_skills.prototype), "Skill_registration_url"));
	($mol_mem(($.$money_app_skills.prototype), "Skill_registration_method"));
	($mol_mem(($.$money_app_skills.prototype), "Skill_registration_body"));
	($mol_mem(($.$money_app_skills.prototype), "Skill_save"));
	($mol_mem(($.$money_app_skills.prototype), "Skill_form"));
	($mol_mem(($.$money_app_skills.prototype), "Skill_card_registration_item"));
	($mol_mem(($.$money_app_skills.prototype), "Skills_level_next"));
...
;
	($.$money_app_caravan) = class $money_app_caravan extends ($.$mol_page) {
		Caravan_amount(){
		...
		Caravan_form(){
			const obj = new this.$.$mol_form_draft();
			(obj.form_fields) = () => ([(this.Caravan_amount())]);
			(obj.buttons) = () => ([(this.Caravan_search())]);
			return obj;
		}
		win(next){
			if(next !== undefined) return next;
		...
		body(){
			return [(this.Caravan_form()), (this.Win())];
		}
	};
	($mol_mem(($.$money_app_caravan.prototype), "Caravan_amount"));
	($mol_mem(($.$money_app_caravan.prototype), "caravan_grab"));
	($mol_mem(($.$money_app_caravan.prototype), "Caravan_search"));
	($mol_mem(($.$money_app_caravan.prototype), "Caravan_form"));
	($mol_mem(($.$money_app_caravan.prototype), "win"));
	($mol_mem(($.$money_app_caravan.prototype), "Win"));
...
;
	($.$money_app_god) = class $money_app_god extends ($.$mol_page) {
		balance_text(next){
			if(next !== undefined) return next;
			return "";
		}
	...
	($mol_mem(($.$money_app_god.prototype), "balance_text"));
	($mol_mem(($.$money_app_god.prototype), "Balance_text"));
...
;
	($.$money_app_game) = class $money_app_game extends ($.$mol_book2_catalog) {
		money(next){
			if(next !== undefined) return next;
			return "1000 💵";
		}
	...
	($mol_mem(($.$money_app_game.prototype), "money"));
	($mol_mem(($.$money_app_game.prototype), "Money_count"));
	($mol_mem(($.$money_app_game.prototype), "GitHub"));
	($mol_mem(($.$money_app_game.prototype), "level"));
	($mol_mem(($.$money_app_game.prototype), "Level"));
	($mol_mem(($.$money_app_game.prototype), "Skills_page"));
	($mol_mem(($.$money_app_game.prototype), "Card_code"));
	($mol_mem(($.$money_app_game.prototype), "Card_date"));
	($mol_mem(($.$money_app_game.prototype), "Card_csv"));
	($mol_mem(($.$money_app_game.prototype), "Card_update"));
	($mol_mem(($.$money_app_game.prototype), "Card"));
	($mol_mem(($.$money_app_game.prototype), "Card_page"));
	($mol_mem(($.$money_app_game.prototype), "Caravan_page"));
	($mol_mem(($.$money_app_game.prototype), "God_page"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $money_app_game.prototype, "menu_links", null);
        $$.$money_app_game = $money_app_game;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$money_app) = class $money_app extends ($.$mol_view) {
		Game_page(){
			const obj = new this.$.$money_app_game();
			return obj;
		}
		title(){
			return "Money Card Hero";
	...
	($mol_mem(($.$money_app.prototype), "Game_page"));
